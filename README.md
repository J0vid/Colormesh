...
```
![](images/plot_points.png) | ![](images/plot_perimeter_points.png) | ![](images/plot_interior_points.png) | ![](images/plots_triangulation.png)
...
```
![](images/uncalib_plotted_points.png) | ![](images/uncalib_plotted_perimeter.png) | ![](images/uncalib_plotted_interior.png) | ![](images/uncalib_plotted_comparison.png)

```{r}
# Plotting the linearized measured color; these will appear darker
