...
#' @return This function reads in Raw image formats and converts them to jpeg. The function returns the paths to the images that were converted. These jpeg locations can then be used by geomorph for landmarking within R.
#' @examples
...
raw2jpeg <- function(imagedir, image.names, writedir){
  ...
  return(paste0(writedir,dir(writedir, pattern = "*.jpg")))
}
